...
par(mfrow = c(2, 2)) 
plot(df$datetime, gap, type="l", xlab="", ylab="Global Active Power", cex=0.2)
plot(df$datetime, voltage, type="l", xlab="datetime", ylab="Voltage")

plot(df$datetime, subM1, type="l", ylab="Energy Submetering", xlab="")
lines(df$datetime, subM2, type="l", col="red")
lines(df$datetime, subM3, type="l", col="blue")
